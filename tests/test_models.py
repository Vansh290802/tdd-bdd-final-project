...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_dataVal_product(self):
        """It should Update a Product and handle invalid ID error"""
        ...
        product_with_invalid_id = ProductFactory()
        product_with_invalid_id.id = None  # Set ID to None to simulate invalid ID
        with self.assertRaises(DataValidationError):
            product_with_invalid_id.update()
